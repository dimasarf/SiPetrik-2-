<div class="card scrollBar" style="width: 665px; max-height: 650px; border: none; overflow-y: scroll; overflow-x: scroll">
            ...
            <div class="container">
                <div class="row">
                        <table class="">
                            ...
                            <tr><td><p style="margin-top: 20px; margin-bottom: -5px; font-size: 13px;">Warna</p></td></tr>
                            <tr>
                            <td><p style="margin-bottom: -5px; font-weight: bold;"><?php echo e($triase->warna); ?></p></td>
